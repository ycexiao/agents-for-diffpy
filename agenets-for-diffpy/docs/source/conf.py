...
# -*- coding: utf-8 -*-
#
# agenets-for-diffpy documentation build configuration file, created by  # noqa: E501
...
try:
    fullversion = version("agenets_for_diffpy")
except Exception:
...
modindex_common_prefix = ["agenets-for-diffpy"]
...
html_context = {
    "display_github": True,
    "github_user": "ycexiao",
    "github_repo": "agenets-for-diffpy",
    "github_version": "main",
...
basename = "agenets-for-diffpy".replace(" ", "").replace(".", "")
...
latex_documents = [
    (
        "index",
        "agenets-for-diffpy.tex",
        "agenets-for-diffpy Documentation",
        ab_authors,
        "manual",
    ),
]
